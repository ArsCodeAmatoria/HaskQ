...
`}
        ...
        <ul>
          ...
          <li><a href="/docs/core-concepts/circuit-composition" className="text-indigo-600 dark:text-indigo-400 hover:underline">Circuit Composition</a> - Learn how to build complex quantum circuits</li>
        </ul>
