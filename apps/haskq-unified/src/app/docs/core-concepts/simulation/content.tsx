...
simulateCircuit numQubits circ = ...`}
        ...
        <ol>
          <li>Explore the Quantum Algorithms section to implement well-known quantum algorithms</li>
          <li>Learn about Circuit Optimization techniques</li>
          <li>Try the Playground interface for interactive simulation</li>
        </ol>
